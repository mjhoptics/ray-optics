...
.. |osp| replace:: :class:`~opticalspec.OpticalSpecs`
.. |specsheet| replace:: :class:`~specsheet.SpecSheet`
.. |pm| replace:: :class:`~paraxialdesign.ParaxialModel`
.. |em| replace:: :class:`~elements.ElementModel`
...
========
   ...
   The |osp| class holds the optical usage definition of the model. Aperture, field of view, wavelength, and focal position are all aspects of the |osp|. The first order properties are calculated and maintained by |osp| in the :attr:`~opticalspec.OpticalSpecs.parax_data` variable.  The usage specification of the optical model is given by the |specsheet| class in combination with the |osp| class. 
   ...
   The system units and other information is contained in the :class:`~opticalmodel.SystemSpec` class. It is the  :attr:`~opticalmodel.OpticalModel.system_spec` attribute in |opm|.
